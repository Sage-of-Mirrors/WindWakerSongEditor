...
namespace WindowsFormsApplication1
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            songSelector.Enabled = false;
            noteCountSelector.Enabled = false;
            note1Direc.Enabled = false;
            note2Direc.Enabled = false;
            note3Direc.Enabled = false;
        ...
        private void saveSongs()
        {
            ...
            BinaryWriter bw = new BinaryWriter(File.Open(openFileDialog1.FileName, FileMode.Open));
